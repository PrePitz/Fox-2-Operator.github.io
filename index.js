        ...
        window.tram = function(t) {
            ...
            function O(e, s, c) {
                ...
                e === void 0)
                    return c;
                var f = c;
                return ye.test(e) || !ke.test(e) ? f = parseInt(e, 10) : ke.test(e) && (f = 1e3 * parseFloat(e)),
                0 > f && (f = 0),
                f === f ? f : c
            }
            function Z(e) {
            ...
            var K = function(e, s, c) {
                ...
                function D($, ue) {
                    ...
                    $ = Object),
                    b.Bare = J;
                    var ee, he = l[e] = $[e], Ce = J[e] = b[e] = new l;
                    return Ce.constructor = b,
                    b.mixin = function(we) {
                        return J[e] = b[e] = D(b, we)[e],
                        b
                    }
                    ,
                    b.open = function(we) {
                        ...
                        f(ee))
                            for (var ze in ee)
                                s.call(ee, ze) && (Ce[ze] = ee[ze]);
                        return u(Ce.init) || (Ce.init = $),
                        b
                    }
                    ,
                    b.open(ue)
            ...
            var h = m.frame = function() {
                ...
                return e && _.bind ? e.bind(G) : function(s) {
                    G.setTimeout(s, 16)
                }
            }()
              , L = m.now = function() {
                ...
                return s && _.bind ? s.bind(e) : Date.now || function() {
                    return +new Date
                }
            }()
              , n = K(function(e) {
                function s(N, re) {
                    ...
                    if (!re.weak || !this.props[oe]) {
                        var Oe = be[0]
                          , xe = this.props[oe];
                        return xe || (xe = this.props[oe] = new Oe.Bare),
                ...
                function he() {
                    ...
                    this.el.style[_.transition.dom] = fe)
                }
                function Ce(N, re, fe) {
                    var oe, be, Oe, xe, He = re !== we, ve = {};
                    for (oe in N)
                        Oe = N[oe],
                        oe in ie ? (ve.transform || (ve.transform = {}),
                        ve.transform[oe] = Oe) : (P.test(oe) && (oe = v(oe)),
                        oe in w ? ve[oe] = Oe : (xe || (xe = {}),
                        xe[oe] = Oe));
                    for (oe in ve) {
                        if (Oe = ve[oe],
                        be = this.props[oe],
                ...
                function _e(N, re) {
                    e[N] = function() {
                        return this.children ? Kt.call(this, re, arguments) : (this.el && re.apply(this, arguments),
                        this)
                    }
                }
                function Kt(N, re) {
                ...
                e.init = function(N) {
                    ...
                    _.backface && Q.hideBackface && r(this.el, _.backface.css, "hidden")
                }
                ,
                _e("add", s),
                _e("start", c),
              ...
              , a = K(function(e) {
                ...
                function f(l) {
                    ...
                    return (D ? V(D[1], D[2], D[3]) : l).replace(/#(\w)(\w)(\w)$/, "#$1$1$2$2$3$3")
                }
                var u = {
                    duration: 500,
                    ease: "ease",
                ...
                e.convert = function(l, D) {
                    if (l == "auto" && this.auto)
                        return l;
                    var $, ue = typeof l == "number", b = typeof l == "string";
                    switch (D) {
                    case y:
                        if (ue)
                            return l;
              ...
              , W = K(a, function(e, s) {
                ...
                e.values = function(f) {
                    var u, l = {};
                    return c.call(this, f, function(D, $, ue) {
                        l[D] = $,
              ...
              , F = K(function(e) {
                ...
                function l(b, J, ee) {
                    return V(b[0] + ee * (J[0] - b[0]), b[1] + ee * (J[1] - b[1]), b[2] + ee * (J[2] - b[2]))
                }
                var D = {
                    ease: j.ease[1],
                    from: 0,
                ...
                ,
                e.play = function() {
                    this.active || (this.start || (this.start = L()),
                    this.active = !0,
                    s(this))
                }
                ,
              ...
              , de = K(F, function(e, s) {
                e.init = function(c) {
                    ...
                    for (f in c.values)
                        u = c.values[f],
                        this.current[f] !== u && this.tweens.push(new F({
                            name: f,
                            from: this.current[f],
                            to: u,
                            duration: c.duration,
            ...
            _.transform && _.backface && (ie.z = [X, "translateZ"],
            ie.rotateZ = [ae],
            ie.scaleZ = [y],
            ie.perspective = [T]);
            var ye = /ms/
    ...
    var st = me((pn,ot)=>{
        ...
        ot.exports = function() {
            ...
            var m = {}
              ...
              , q = Object.keys
              , T = V.bind
              , X = t.each = t.forEach = function(d, p, k) {
                if (d == null)
                    return d;
                if (te && d.forEach === te)
                    d.forEach(p, k);
                    ...
                    for (var _ = 0, H = d.length; _ < H; _++)
                        if (p.call(k, d[_], _, d) === m)
                            return
                } else
                    for (var U = t.keys(d), _ = 0, H = U.length; _ < H; _++)
                        if (p.call(k, d[U[_]], U[_], d) === m)
                            return;
                return d
            }
            ;
            t.map = t.collect = function(d, p, k) {
                var _ = [];
                return d == null ? _ : K && d.map === K ? d.map(p, k) : (X(d, function(H, U, h) {
                    _.push(p.call(k, H, U, h))
                }),
                _)
            }
            ,
            t.find = t.detect = function(d, p, k) {
                var _;
                return ae(d, function(H, U, h) {
                    if (p.call(k, H, U, h))
                        return _ = H,
                        !0
                }),
            ...
            ,
            t.filter = t.select = function(d, p, k) {
                var _ = [];
                return d == null ? _ : z && d.filter === z ? d.filter(p, k) : (X(d, function(H, U, h) {
                    p.call(k, H, U, h) && _.push(H)
                }),
                _)
            }
            ;
            var ae = t.some = t.any = function(d, p, k) {
                p || (p = t.identity);
                var _ = !1;
                return d == null ? _ : Y && d.some === Y ? d.some(p, k) : (X(d, function(H, U, h) {
                    if (_ || (_ = p.call(k, H, U, h)))
                        return m
                }),
                !!_)
            }
            ;
            t.contains = t.include = function(d, p) {
                return d == null ? !1 : B && d.indexOf === B ? d.indexOf(p) != -1 : ae(d, function(k) {
                    return k === p
                })
            }
            ,
            ...
            t.debounce = function(d, p, k) {
                var _, H, U, h, L, n = function() {
                    var o = t.now() - h;
                    o < p ? _ = setTimeout(n, p - o) : (_ = null,
                    k || (L = d.apply(U, H),
                    U = H = null))
                };
                return function() {
            ...
            var ce = /(.)^/
              ...
              , R = /^\s*(\w|\$)+\s*$/;
            return t.template = function(d, p, k) {
                !p && k && (p = k),
                p = t.defaults({}, p, t.templateSettings);
                var _ = RegExp([(p.escape || ce).source, (p.interpolate || ce).source, (p.evaluate || ce).source].join("|") + "|$", "g")
                  , H = 0
                  , U = "__p+='";
                d.replace(_, function(o, a, i, E, W) {
                    return U += d.slice(H, W).replace(Ee, pe),
                    H = W + o.length,
                    a ? U += `'+
...
` + U + "}",
    ...
    var Te = me((mn,vt)=>{
        ...
        ;
        function ct(t) {
            se.env() && (Se(t.design) && Ae.on("__wf_design", t.design),
        ...
        var Ue = navigator.userAgent.toLowerCase()
          ...
          , Jt = se.env.chrome = /chrome/.test(Ue) && /Google/.test(navigator.vendor) && parseInt(Ue.match(/chrome\/(\d+)\./)[1], 10)
          , en = se.env.ios = /(ipod|iphone|ipad)/.test(Ue);
        se.env.safari = /safari/.test(Ue) && !Jt && !en;
        var je;
        lt && jt.on("touchstart mousedown", function(t) {
            je = t.target
        });
        ...
        function Je(t, m) {
            var v = []
              , x = {};
            return x.up = Le.throttle(function(V) {
    ...
    var gt = me((gn,mt)=>{
        "use strict";
        var pt = Te();
        pt.define("brand", mt.exports = function(t) {
            var m = {}, v = document, x = t("html"), V = t("body"), A = ".w-webflow-badge", M = window.location, I = /PhantomJS/i.test(navigator.userAgent), O = "fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange", Z;
            m.ready = function() {
            ...
            ;
            function te() {
                var S = v.fullScreen || v.mozFullScreen || v.webkitIsFullScreen || v.msFullscreenElement || !!v.webkitFullscreenElement;
                t(Z).attr("style", S ? "display: none !important;" : "")
            }
            function K() {
                var S = t('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs")
                  , z = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon-d2.89e12c322e.svg").attr("alt", "").css({
                    marginRight: "4px",
                    width: "26px"
                })
                  , G = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-text-d2.c82cec3b78.svg").attr("alt", "Made in Webflow");
                return S.append(z, G),
                S[0]
            }
            function j() {
    ...
    var bt = me((wn,wt)=>{
        "use strict";
        var et = Te();
        et.define("edit", wt.exports = function(t, m, v) {
            if (v = v || {},
            (et.env("test") || et.env("frame")) && !v.fixture && !rn())
                return {
                    exit: 1
                };
            var x = {}, V = t(window), A = t(document.documentElement), M = document.location, I = "hashchange", O, Z = v.load || j, te = !1;
            try {
                te = localStorage && localStorage.getItem && localStorage.getItem("WebflowEditor")
            } catch {}
            te ? Z() : M.search ? (/[?&](edit)(?:[=&?]|$)/.test(M.search) || /\?edit$/.test(M.href)) && Z() : V.on(I, K).triggerHandler(I);
            function K() {
            ...
            function P(q) {
                ...
                var X = function(ae) {
                    ae.data === "WF_third_party_cookies_unsupported" ? (y(T, X),
                    q(!1)) : ae.data === "WF_third_party_cookies_supported" && (y(T, X),
                    q(!0))
                };
                T.onerror = function() {
                    y(T, X),
        ...
        on.define("focus-visible", yt.exports = function() {
            function t(v) {
                ...
                function O(y) {
                    var q = y.type
                      , T = y.tagName;
                    return !!(T === "INPUT" && M[q] && !y.readOnly || T === "TEXTAREA" && !y.readOnly || y.isContentEditable)
                }
                function Z(y) {
                ...
                function K(y) {
                    y.metaKey || y.altKey || y.ctrlKey || (I(v.activeElement) && Z(v.activeElement),
                    x = !0)
                }
                function j() {
                    x = !1
                ...
                function z(y) {
                    I(y.target) && y.target.hasAttribute("data-wf-focus-visible") && (V = !0,
                ...
                function G() {
                    document.visibilityState === "hidden" && (V && (x = !0),
                    Y())
                }
                function Y() {
                ...
                function P(y) {
                    y.target.nodeName && y.target.nodeName.toLowerCase() === "html" || (x = !1,
                    B())
                }
    ...
    var _t = me((yn,kt)=>{
        "use strict";
        var Et = Te();
        Et.define("focus", kt.exports = function() {
            var t = []
              , m = !1;
            function v(M) {
                m && (M.preventDefault(),
            ...
            function x(M) {
                var I = M.target
                  , O = I.tagName;
                return /^a$/i.test(O) && I.href != null || /^(button|textarea)$/i.test(O) && I.disabled !== !0 || /^input$/i.test(O) && /^(button|reset|submit|radio|checkbox)$/i.test(I.type) && !I.disabled || !/^(button|input|textarea|select|a)$/i.test(O) && !Number.isNaN(Number.parseFloat(I.tabIndex)) || /^audio$/i.test(O) || /^video$/i.test(O) && I.controls === !0
            }
            function V(M) {
                x(M) && (m = !0,
                setTimeout(()=>{
                    for (m = !1,
                    M.target.focus(); t.length > 0; ) {
                        var I = t.pop();
            ...
            function A() {
                typeof document < "u" && document.body.hasAttribute("data-wf-focus-within") && Et.env.safari && (document.addEventListener("mousedown", V, !0),
    ...
    var Lt = me((xn,Ot)=>{
        "use strict";
        var Ne = Te();
        Ne.define("links", Ot.exports = function(t, m) {
            var v = {}, x = t(window), V, A = Ne.env(), M = window.location, I = document.createElement("a"), O = "w--current", Z = /index\.(html|php)$/, te = /\/$/, K, j;
            ...
            function S() {
                ...
                Ne.scroll.off(G),
                K = [];
                for (var B = document.links, P = 0; P < B.length; ++P)
                    z(B[P]);
                K.length && (Ne.scroll.on(G),
                G())
            }
            function z(B) {
                if (!B.getAttribute("hreflang")) {
                    var P = V && B.getAttribute("href-disabled") || B.getAttribute("href");
                    if (I.href = P,
                    !(P.indexOf(":") >= 0)) {
                        var y = t(B);
                        if (I.hash.length > 1 && I.host + I.pathname === M.host + M.pathname) {
                            if (!/^#[a-zA-Z0-9\-\_]+$/.test(I.hash))
                                return;
                            var q = t(I.hash);
                            q.length && K.push({
                                link: y,
                        ...
                        if (!(P === "#" || P === "")) {
                            var T = I.href === M.href || P === j || Z.test(P) && te.test(j);
                            Y(y, O, T)
                        }
                    }
                }
    ...
    var Tt = me((En,At)=>{
        "use strict";
        var Xe = Te();
        Xe.define("scroll", At.exports = function(t) {
            var m = {
              ...
              , A = t(document)
              , M = t(document.body)
              , I = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function(R) {
            ...
            function y(R, d) {
                ...
                case "add":
                    p = R.attr("tabindex"),
                    p ? R.attr("data-wf-tabindex-swap", p) : R.attr("tabindex", "-1");
                    break;
                case "remove":
            ...
            function T(R) {
                if (v.hash !== R && x && x.pushState && !(Xe.env.chrome && v.protocol === "file:")) {
            ...
            function ce(R, d, p) {
                if (P())
                    return 0;
                var k = 1;
                return M.add(R).each(function(_, H) {
    ...
    var St = me((kn,Ct)=>{
        "use strict";
        var sn = Te();
        sn.define("touch", Ct.exports = function(t) {
            var m = {}
            ...
            m.init = function(A) {
                return A = typeof A == "string" ? t(A).get(0) : A,
                A ? new x(A) : null
            }
            ;
            function x(A) {
                var M = !1, I = !1, O = Math.min(Math.round(window.innerWidth * .04), 40), Z, te;
                ...
                function j(Y) {
                    if (M) {
                        ...
                        var B = Y.touches
                          ...
                          , y = P - te;
                        te = P,
                        Math.abs(y) > O && v && String(v()) === "" && (V("swipe", Y, {
            ...
            return m.instance = m.init(document),
            m
        }
        )
    }
    ...
    var Ft = me((On,Wt)=>{
        "use strict";
        var $e = Te();
        $e.define("forms", Wt.exports = function(t, m) {
            var v = {}, x = t(document), V, A = window.location, M = window.XDomainRequest && !window.atob, I = ".w-form", O, Z = /e(-)?mail/i, te = /^\S+@\S+$/, K = window.alert, j = $e.env(), S, z, G, Y = /list-manage[1-9]?.com/i, B = m.debounce(function() {
            ...
            function P() {
                ...
                M && z.indexOf("https://webflow.com") >= 0 && (z = z.replace("https://webflow.com", "https://formdata.webflow.com")),
                G = `${z}/signFile`,
                V = t(I + " form"),
                V.length && V.each(y)
            }
            ...
            function q() {
                ...
                let h = ".w-checkbox-input"
                  ...
                  , E = [["checkbox", h], ["radio", L]];
                x.on("change", I + ' form input[type="checkbox"]:not(' + h + ")", W=>{
                    t(W.target).siblings(h).toggleClass(n)
                }
                ),
                x.on("change", I + ' form input[type="radio"]', W=>{
                    t(`input[name="${W.target.name}"]:not(${h})`).map((ne,de)=>t(de).siblings(L).removeClass(n));
                    let F = t(W.target);
                    F.hasClass("w-radio-input") || F.siblings(L).addClass(n)
                }
                ),
                E.forEach(([W,F])=>{
                    x.on("focus", I + ` form input[type="${W}"]:not(` + F + ")", ne=>{
                        t(ne.target).siblings(F).addClass(o),
                        t(ne.target).filter(i).siblings(F).addClass(a)
                    }
                    ),
                    x.on("blur", I + ` form input[type="${W}"]:not(` + F + ")", ne=>{
            ...
            function ae(h, L) {
                var n = null;
                return L = L || {},
                h.find(':input:not([type="submit"]):not([type="file"])').each(function(o, a) {
                    var i = t(a)
                      , E = i.attr("type")
                      , W = i.attr("data-name") || i.attr("name") || "Field " + (o + 1);
                    W = encodeURIComponent(W);
                    var F = i.val();
                    if (E === "checkbox")
                        F = i.is(":checked");
                    else if (E === "radio") {
                        if (L[W] === null || typeof L[W] == "string")
                            return;
                        F = h.find('input[name="' + i.attr("name") + '"]:checked').val() || null
                    }
            ...
            function ce(h) {
                var L = {};
                return h.find(':input[type="file"]').each(function(n, o) {
                    var a = t(o)
                      , i = a.attr("data-name") || a.attr("name") || "File " + (n + 1)
                      , E = a.attr("data-value");
                    typeof E == "string" && (E = t.trim(E)),
                    L[i] = E
                }),
                L
            }
            ...
            function pe(h, L, n, o) {
                var a = null;
                return L === "password" ? a = "Passwords cannot be submitted." : h.attr("required") ? o ? Z.test(h.attr("type")) && (te.test(o) || (a = "Please enter a valid email address for: " + n)) : a = "Please fill out the required field: " + n : n === "g-recaptcha-response" && !o && (a = "Please confirm you\u2019re not a robot."),
                a
            }
            function R(h) {
                k(h),
            ...
            function _(h, L) {
                ...
                function e(u) {
                    var l = u.responseJSON && u.responseJSON.msg
                      , D = ye;
                    typeof l == "string" && l.indexOf("InvalidFileTypeError") === 0 ? D = ie : typeof l == "string" && l.indexOf("MaxFileSizeError") === 0 && (D = w),
                    Q.text(D),
                    F.removeAttr("data-value"),
                    F.val(""),
                    i.toggle(!1),
    ...
    var Dt = me((Ln,It)=>{
        ...
        var nt = window.jQuery
          ...
          , Ve = {
            ...
            intro: function(t, m) {
                m.__wf_intro || (m.__wf_intro = !0,
                nt(m).triggerHandler(Re.types.INTRO))
            },
            outro: function(t, m) {
                m.__wf_intro && (m.__wf_intro = null,
                nt(m).triggerHandler(Re.types.OUTRO))
            }
        };
        Re.triggers = {};
        Re.types = {
        ...
        Re.init = function() {
            ...
            Ke = [],
            nt.extend(Re.triggers, Ve)
        }
        ;
        Re.async = function() {
            for (var t in Ve) {
                var m = Ve[t];
                Ve.hasOwnProperty(t) && (Re.triggers[t] = function(v, x) {
                    Ke.push([m, x])
                }
                )
            }
    ...
    var it = me((An,Nt)=>{
        ...
        var un = window.jQuery
          ...
          , cn = {
            ...
            intro: function(t, m) {
                rt.triggers.intro(t, m),
                Pt(m, "COMPONENT_ACTIVE")
            },
            outro: function(t, m) {
                rt.triggers.outro(t, m),
                Pt(m, "COMPONENT_INACTIVE")
            }
        };
        Ge.triggers = {};
        Ge.types = {
    ...
    var Ht = me((Tn,zt)=>{
        ...
        Me.define("navbar", zt.exports = function(t, m) {
            var v = {}, x = t.tram, V = t(window), A = t(document), M = m.debounce, I, O, Z, te, K = Me.env(), j = '<div class="w-nav-overlay" data-wf-ignore />', S = ".w-nav", z = "w--open", G = "w--nav-dropdown-open", Y = "w--nav-dropdown-toggle-open", B = "w--nav-dropdown-list-open", P = "w--nav-link-open", y = fn.triggers, q = t();
            v.ready = v.design = v.preview = T,
            v.destroy = function() {
                q = t(),
                X(),
                O && O.length && O.each(Ee)
            }
            ;
            function T() {
                Z = K && Me.env("design"),
            ...
            function k(r) {
                return function(g) {
                    ...
                    case ge.HOME:
                    case ge.END:
                        return r.open ? (g.keyCode === ge.END ? r.selectedIdx = r.links.length - 1 : r.selectedIdx = 0,
                        H(r),
                        g.preventDefault(),
            ...
            function _(r) {
                return function(g) {
                    if (r.open)
                        ...
                        case ge.HOME:
                        case ge.END:
                            return g.keyCode === ge.END ? r.selectedIdx = r.links.length - 1 : r.selectedIdx = 0,
                            H(r),
                            g.preventDefault(),
                            g.stopPropagation();
                        case ge.ESCAPE:
            ...
            function n(r) {
                return r.outside && A.off("click" + S, r.outside),
                function(g) {
                    var C = t(g.target);
                    te && C.closest(".w-editor-bem-EditorOverlay").length || o(r, C)
                }
            }
            ...
            function de(r) {
                ...
                return g.animOver ? r.menu.height(C) : r.el.css("position") !== "fixed" && (C -= r.el.outerHeight(!0)),
            ...
            function Q(r, g) {
                ...
                var C = r.config;
                if ((C.animation === "none" || !x.support.transform || C.duration <= 0) && (g = !0),
                y.outro(0, r.el[0]),
    ...
    var Xt = me((Cn,Bt)=>{
        ...
        var Ie = Te()
          ...
          , Ut = 'a[href], area[href], [role="button"], input, select, textarea, button, iframe, object, embed, *[tabindex], *[contenteditable]';
        Ie.define("slider", Bt.exports = function(t, m) {
            var v = {}, x = t.tram, V = t(document), A, M, I = Ie.env(), O = ".w-slider", Z = '<div class="w-slider-dot" data-wf-ignore />', te = '<div aria-live="off" aria-atomic="true" class="w-slider-aria-label" data-wf-ignore />', K = "w-slider-force-show", j = ln.triggers, S, z = !1;
            v.ready = function() {
                M = Ie.env("design"),
                G()
            }
            ...
            function Y() {
                Ie.resize.off(P),
                Ie.redraw.off(v.redraw)
            }
            function B() {
                Ie.resize.on(P),
                Ie.redraw.on(v.redraw)
            }
            function P() {
            ...
            function y(n, o) {
                ...
                if (E || (E = "w-slider-mask-" + n,
                i.mask.attr("id", E)),
                !M && !i.ariaLiveLabel && (i.ariaLiveLabel = t(te).appendTo(i.mask)),
                ...
                i.nav.off(O),
                q(i),
                M ? (i.el.on("setting" + O, d(i)),
                R(i),
                i.hasTimer = !1) : (i.el.on("swipe" + O, d(i)),
                ...
                I || i.mask.contents().filter(function() {
            ...
            function q(n) {
                ...
                T(n.el.attr("data-hide-arrows")) ? o.hideArrows = !0 : n.config.hideArrows && (n.left.show(),
                n.right.show()),
            ...
            function k(n, o) {
                ...
                var E = o.index
                  , W = {};
                E < 0 ? (E = i.length - 1,
                a.infinite && (W.x = -n.endX,
                W.from = 0,
                W.to = i[0].width)) : E >= i.length && (E = 0,
                a.infinite && (W.x = i[i.length - 1].width,
                W.from = -i[i.length - 1].x,
                W.to = W.from - W.x)),
                n.index = E;
                var F = n.nav.children().eq(E).addClass("w-active").attr("aria-pressed", "true").attr("tabindex", "0");
                n.nav.children().not(F).removeClass("w-active").attr("aria-pressed", "false").attr("tabindex", "-1"),
                ...
                if (r.find(Ut).removeAttr("tabindex"),
                ...
                if (n.index === n.previous)
                    return;
                if (M || n.ariaLiveLabel.text(`Slide ${E + 1} of ${i.length}.`),
                w === "cross") {
                ...
                a.infinite && W.x ? (x(n.slides.not(g)).set({
                    visibility: "",
                    x: W.x
                }).add(s).start({
                    x: de
                ...
                n.shifted = g) : (a.infinite && n.shifted && (x(n.shifted).set({
                    visibility: "",
                    x: ne
                }),
                n.shifted = null),
            ...
            function U(n) {
                ...
                for (var E = 0, W = n.pages; E < W; E++)
                    a = t(Z),
                    a.attr("aria-label", "Show slide " + (E + 1) + " of " + W).attr("aria-pressed", "false").attr("role", "button").attr("tabindex", "-1"),
